      ...
      <div className="hero min-h-[80vh] custom-img flex items-center justify-center max-w-full bg-fixed bg-no-repeat bg-center">
        <div className="hero-content text-neutral-content text-center flex flex-col items-center justify-center">
          <div className="max-w-md">
            <h1 className="mb-5 scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl text-black">
              Clothique
            </h1>
            <p className="mb-5 scroll-m-20 text-xl font-extrabold tracking-tight lg:text-5x text-black">
            ...
            <div className="mt-5 flex justify-center">
              <Button
               ...
               hover:outline-orange-600 group text-black"
              >
